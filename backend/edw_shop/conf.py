# -*- coding: utf-8 -*-
"""
Source: https://github.com/awesto/django-shop/blob/e5b5cd0ac44b17c9d0cc6495e299a2390ac1372a/shop/conf.py
"""
        ...
        if pss:
            ...
            class ProductSummarySerializer(ProductSerializer):
                ...
                class Meta(ProductSerializer.Meta):
                    fields = ['id', 'uuid', 'product_name', 'slug', 'product_url', 'detail_url', 'product_model', 'price',
